...
*line_capacity_min(t,l)$(mapll(t,l))..
         pf(t,l) =g= -l_max(l)*line_capacity;
line_capacity_max(t,l)..
*line_capacity_max(t,l)$(maplg(t,l))..
...
parameter time_elapsed,timea(da);
parameter tlamin(da,t,l),tlamax(da,t,l);
parameter tlmin(t,l),tlmax(t,l);

loop(da,

w_det(t,w)  =  w_detl(da,t,w);
d(t,s) = dl(da,t,s)
solve ep using mip minimizing obj;
time_elapsed = ep.etSolver;
tlmin(t,l)$((pf.l(t,l) + l_max(l)*line_capacity) lt epl and -epl lt (pf.l(t,l) + l_max(l)*line_capacity)) = 1;
tlmax(t,l)$((pf.l(t,l) - l_max(l)*line_capacity) lt epl and -epl lt (pf.l(t,l) - l_max(l)*line_capacity) ) = 1;

tlamin(da,t,l) = tlmin(t,l);
tlamax(da,t,l) = tlmax(t,l);
timea(da) = time_elapsed;
...
Execute_Unload 'uc2',tlamin,tlamax,timea;
